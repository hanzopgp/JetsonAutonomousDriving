...
NUM_PER_SZ = 20			# number of images for each bounding-box size
...
def generate_box():
	i = 0
	for size in range(INIT_SIZE, IMG_SIZE+1, SIZE_STEP):
...
def camera_loop(vc):
	...
	while True:
		...
		cv2.rectangle(frame, (box_x,box_y), (end_x,end_y), (0,255,0), 1)
